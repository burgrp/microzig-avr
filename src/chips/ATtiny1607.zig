...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const EVSYS = extern struct {
            ...
            pub const EVSYS_ASYNCUSER11 = enum(u8) {
                ///  Off
                OFF = 0x0,
                ///  Synchronous Event Channel 0
                SYNCCH0 = 0x1,
            ...
            pub const EVSYS_ASYNCUSER12 = enum(u8) {
                ///  Off
                OFF = 0x0,
                ///  Synchronous Event Channel 0
                SYNCCH0 = 0x1,
            ...
            ///  Asynchronous User Ch 11 Input Selection - TCB1
            ASYNCUSER11: mmio.Mmio(packed struct(u8) {
                ///  Asynchronous User Ch 11 Input Selection - TCB1
                ASYNCUSER11: packed union {
                    raw: u8,
                    value: EVSYS_ASYNCUSER11,
                },
            }),
            ///  Asynchronous User Ch 12 Input Selection - ADC1
            ASYNCUSER12: mmio.Mmio(packed struct(u8) {
                ///  Asynchronous User Ch 12 Input Selection - ADC0
                ASYNCUSER12: packed union {
                    raw: u8,
                    value: EVSYS_ASYNCUSER12,
                },
            }),
            reserved34: [3]u8,
