...
pub const devices = struct {
    pub const AT90PWM316 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  Power Stage Controller
            pub const PSC1 = @intToPtr(*volatile types.peripherals.PSC.PSC1, 0xa2);
            ///  Power Stage Controller
            pub const PSC2 = @intToPtr(*volatile types.peripherals.PSC.PSC2, 0xa4);
            ///  Digital-to-Analog Converter
            pub const DAC = @intToPtr(*volatile types.peripherals.DAC, 0xaa);
            ///  USART
            pub const USART = @intToPtr(*volatile types.peripherals.USART, 0xc0);
            ///  Extended USART
            pub const EUSART = @intToPtr(*volatile types.peripherals.EUSART, 0xc8);
        };
    };
};
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const USART = extern struct {
            ...
            UBRRH: mmio.Mmio(packed struct(u8) {
                ///  USART Baud Rate Register Bits
                UBRR: u4,
                padding: u4,
            }),
