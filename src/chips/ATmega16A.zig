...
pub const devices = struct {
    pub const ATmega16A = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const TWI = @intToPtr(*volatile types.peripherals.TWI, 0x20);
            ///  Analog-to-Digital Converter
            pub const ADC = @intToPtr(*volatile types.peripherals.ADC, 0x24);
            ///  Analog Comparator
            pub const AC = @intToPtr(*volatile types.peripherals.AC, 0x28);
            ///  USART
            pub const USART = @intToPtr(*volatile types.peripherals.USART, 0x29);
            ...
            pub const TC2 = @intToPtr(*volatile types.peripherals.TC8_ASYNC.TC2, 0x42);
            ///  Timer/Counter, 16-bit
            pub const TC1 = @intToPtr(*volatile types.peripherals.TC16.TC1, 0x46);
            ///  Timer/Counter, 8-bit
            pub const TC0 = @intToPtr(*volatile types.peripherals.TC8.TC0, 0x50);
            ///  CPU Registers
            pub const CPU = @intToPtr(*volatile types.peripherals.CPU, 0x50);
            ///  JTAG Interface
            pub const JTAG = @intToPtr(*volatile types.peripherals.JTAG, 0x51);
            ///  External Interrupts
            pub const EXINT = @intToPtr(*volatile types.peripherals.EXINT, 0x54);
            ///  Bootloader
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const CPU = extern struct {
            pub const CPU_SLEEP_MODE_3BITS = enum(u4) {
                ///  Idle
                IDLE = 0x0,
        ...
        pub const TC8_ASYNC = struct {
            ...
            pub const TC2 = extern struct {
                ...
                OCR2: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter2 Output Compare bits
                    OCR2: u8,
                }),
                ///  Timer/Counter2
        ...
        pub const USART = extern struct {
            ...
            UBRRL: mmio.Mmio(packed struct(u8) {
