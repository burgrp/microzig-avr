...
pub const devices = struct {
    pub const ATmega48PB = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  Analog Comparator
            pub const AC = @as(*volatile types.peripherals.AC, @ptrFromInt(0x4f));
            ///  Watchdog Timer
            ...
            ///  Device ID
            pub const DEVICEID = @as(*volatile types.peripherals.DEVICEID, @ptrFromInt(0xf0));
        };
    };
};
    ...
    pub const peripherals = struct {
        ...
        pub const FUSE = extern struct {
            pub const ENUM_SUT_CKSEL = enum(u6) {
                ...
                INTRCOSC_8MHZ_6CK_14CK_65MS_DEFAULT = 0x22,
