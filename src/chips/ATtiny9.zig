...
pub const devices = struct {
    pub const ATtiny9 = struct {
        ...
        pub const peripherals = struct {
            ///  I/O Port
            pub const PORTB = @as(*volatile types.peripherals.PORT.PORTB, @ptrFromInt(0x0));
            ///  Fuses
            ...
            ///  External Interrupts
            pub const EXINT = @as(*volatile types.peripherals.EXINT, @ptrFromInt(0x10));
            ///  Analog Comparator
