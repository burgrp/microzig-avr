...
pub const devices = struct {
    pub const ATmega2560 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  USART
            pub const USART2 = @as(*volatile types.peripherals.USART.USART2, @ptrFromInt(0xd0));
            ///  I/O Port
            pub const PORTH = @as(*volatile types.peripherals.PORT.PORTH, @ptrFromInt(0x100));
            ///  I/O Port
            pub const PORTJ = @as(*volatile types.peripherals.PORT.PORTJ, @ptrFromInt(0x103));
            ///  I/O Port
            pub const PORTK = @as(*volatile types.peripherals.PORT.PORTK, @ptrFromInt(0x106));
            ///  I/O Port
            pub const PORTL = @as(*volatile types.peripherals.PORT.PORTL, @ptrFromInt(0x109));
            ///  USART
            pub const USART3 = @as(*volatile types.peripherals.USART.USART3, @ptrFromInt(0x130));
        };
    };
};
