...
pub const devices = struct {
    pub const ATmega16M1 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const ADC = @as(*volatile types.peripherals.ADC, @ptrFromInt(0x75));
            ///  Digital-to-Analog Converter
            pub const DAC = @as(*volatile types.peripherals.DAC, @ptrFromInt(0x90));
            ///  Power Stage Controller
            pub const PSC = @as(*volatile types.peripherals.PSC, @ptrFromInt(0xa0));
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const TC8 = struct {
            ...
            pub const TC0 = extern struct {
                ...
                OCR0A: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter0 Output Compare bits
                    OCR0A: u8,
                }),
        ...
        pub const TC16 = struct {
            ...
            pub const TC1 = extern struct {
                ...
                OCR1A: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter1 Output Compare bits
                    OCR1A: u16,
                }),
        ...
        pub const PSC = extern struct {
            ...
            POCR0SA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SA bits
                POCR0SA: u12,
                padding: u4,
            }),
            ///  PSC Module 0 Output Compare RA Register
            POCR0RA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare RA bits
                POCR0RA: u12,
                padding: u4,
            }),
            ///  PSC Module 0 Output Compare SB Register
            POCR0SB: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SB bits
                POCR0SB: u12,
                padding: u4,
            }),
            ///  PSC Module 1 Output Compare SA Register
            POCR1SA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SA bits
                POCR1SA: u12,
                padding: u4,
            }),
            ///  PSC Module 1 Output Compare RA Register
            POCR1RA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare RA bits
                POCR1RA: u12,
                padding: u4,
            }),
            ///  PSC Module 1 Output Compare SB Register
            POCR1SB: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SB bits
                POCR1SB: u12,
                padding: u4,
            }),
            ///  PSC Module 2 Output Compare SA Register
            POCR2SA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SA bits
                POCR2SA: u12,
                padding: u4,
            }),
            ///  PSC Module 2 Output Compare RA Register
            POCR2RA: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare RA bits
                POCR2RA: u12,
                padding: u4,
            }),
            ///  PSC Module 2 Output Compare SB Register
            POCR2SB: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare SB bits
                POCR2SB: u12,
                padding: u4,
            }),
            ///  PSC Output Compare RB Register
            POCR_RB: mmio.Mmio(packed struct(u16) {
                ///  PSC Output Compare RB bits
                POCR_RB: u12,
                padding: u4,
            }),
