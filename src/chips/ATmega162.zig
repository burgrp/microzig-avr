...
pub const devices = struct {
    pub const ATmega162 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  USART
            pub const USART1 = @intToPtr(*volatile types.peripherals.USART.USART1, 0x20);
            ///  CPU Registers
            pub const CPU = @intToPtr(*volatile types.peripherals.CPU, 0x24);
            ///  JTAG Interface
            pub const JTAG = @intToPtr(*volatile types.peripherals.JTAG, 0x24);
            ///  I/O Port
            pub const PORTE = @intToPtr(*volatile types.peripherals.PORT.PORTE, 0x25);
            ///  Analog Comparator
            ...
            pub const TC1 = @intToPtr(*volatile types.peripherals.TC16.TC1, 0x44);
            ///  Timer/Counter, 8-bit
            pub const TC0 = @intToPtr(*volatile types.peripherals.TC8.TC0, 0x51);
            ///  External Interrupts
            pub const EXINT = @intToPtr(*volatile types.peripherals.EXINT, 0x55);
            ///  Bootloader
            pub const BOOT_LOAD = @intToPtr(*volatile types.peripherals.BOOT_LOAD, 0x57);
            ///  Timer/Counter, 16-bit
            pub const TC3 = @intToPtr(*volatile types.peripherals.TC16.TC3, 0x7c);
        };
    };
};
