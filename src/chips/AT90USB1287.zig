...
pub const devices = struct {
    pub const AT90USB1287 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  USB Host Registers
            pub const USB_HOST = @intToPtr(*volatile types.peripherals.USB_HOST, 0x9e);
            ...
            ///  USB Controller
            pub const USB_GLOBAL = @intToPtr(*volatile types.peripherals.USB_GLOBAL, 0xd7);
            ///  USB Device Registers
            pub const USB_DEVICE = @intToPtr(*volatile types.peripherals.USB_DEVICE, 0xe0);
        };
    };
};
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const USB_GLOBAL = extern struct {
            ...
            reserved6: [2]u8,
            OTGCON: mmio.Mmio(packed struct(u8) {
                VBUSRQC: u1,
                VBUSREQ: u1,
                VBUSHWC: u1,
                SRPSEL: u1,
            ...
            OTGIEN: mmio.Mmio(packed struct(u8) {
                SRPE: u1,
                VBERRE: u1,
                BCERRE: u1,
                ROLEEXE: u1,
            ...
            OTGINT: mmio.Mmio(packed struct(u8) {
                SRPI: u1,
                VBERRI: u1,
                BCERRI: u1,
                ROLEEXI: u1,
            ...
            reserved34: [25]u8,
            OTGTCON: mmio.Mmio(packed struct(u8) {
                VALUE_2: u3,
                reserved5: u2,
                PAGE: u2,
                OTGTCON_7: u1,
        ...
        pub const USB_HOST = extern struct {
            UHCON: mmio.Mmio(packed struct(u8) {
                SOFEN: u1,
                RESET: u1,
                RESUME: u1,
                padding: u5,
            }),
            UHINT: mmio.Mmio(packed struct(u8) {
                DCONNI: u1,
                DDISCI: u1,
                RSTI: u1,
                RSMEDI: u1,
            ...
            UHIEN: mmio.Mmio(packed struct(u8) {
                DCONNE: u1,
                DDISCE: u1,
                RSTE: u1,
                RSMEDE: u1,
            ...
            UHFLEN: u8,
            UPINRQX: u8,
            UPINTX: mmio.Mmio(packed struct(u8) {
                RXINI: u1,
                RXSTALLI: u1,
                TXOUTI: u1,
                TXSTPI: u1,
            ...
            UPNUM: u8,
            UPRST: mmio.Mmio(packed struct(u8) {
                PRST: u7,
                padding: u1,
            }),
            UPCONX: mmio.Mmio(packed struct(u8) {
                PEN: u1,
                reserved3: u2,
                RSTDT: u1,
                reserved5: u1,
            ...
            UPCFG0X: mmio.Mmio(packed struct(u8) {
                PEPNUM: u4,
                PTOKEN: u2,
                PTYPE: u2,
            }),
            UPCFG1X: mmio.Mmio(packed struct(u8) {
                reserved1: u1,
                ALLOC: u1,
                PBK: u2,
                PSIZE: u3,
            ...
            UPSTAX: mmio.Mmio(packed struct(u8) {
                NBUSYK: u2,
                DTSEQ: u2,
                reserved5: u1,
                UNDERFI: u1,
            ...
            UPCFG2X: u8,
            UPIENX: mmio.Mmio(packed struct(u8) {
                RXINE: u1,
                RXSTALLE: u1,
                TXOUTE: u1,
                TXSTPE: u1,
            ...
            UPDATX: u8,
            reserved87: [69]u8,
            UPERRX: mmio.Mmio(packed struct(u8) {
                DATATGL: u1,
                DATAPID: u1,
                PID: u1,
                TIMEOUT: u1,
