...
pub const devices = struct {
    pub const ATmega329P = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const LCD = @as(*volatile types.peripherals.LCD, @ptrFromInt(0xe4));
        };
    };
};
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const LCD = extern struct {
            ...
            reserved8: [4]u8,
            ///  LCD Data Register 0
            LCDDR0: mmio.Mmio(packed struct(u8) {
            ...
            ///  LCD Data Register 1
            LCDDR1: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG008: u1,
                ///  LCD memory bit segment
                SEG009: u1,
            ...
            ///  LCD Data Register 2
            LCDDR2: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG016: u1,
                ///  LCD memory bit segment
                SEG017: u1,
            ...
            ///  LCD Data Register 3
            LCDDR3: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG024: u1,
                ///  LCD memory bit segment
                SEG025: u1,
            ...
            reserved13: [1]u8,
            ///  LCD Data Register 5
            LCDDR5: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG100: u1,
                ///  LCD memory bit segment
                SEG101: u1,
            ...
            ///  LCD Data Register 6
            LCDDR6: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG108: u1,
                ///  LCD memory bit segment
                SEG109: u1,
            ...
            ///  LCD Data Register 7
            LCDDR7: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG116: u1,
                ///  LCD memory bit segment
                SEG117: u1,
            ...
            ///  LCD Data Register 8
            LCDDR8: mmio.Mmio(packed struct(u8) {
                ///  LCD memory bit segment
                SEG124: u1,
                ///  LCD memory bit segment
                SEG125: u1,
