...
pub const devices = struct {
    pub const ATtiny861A = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const TC1 = @intToPtr(*volatile types.peripherals.TC16.TC1, 0x20);
            ///  Analog-to-Digital Converter
            pub const ADC = @intToPtr(*volatile types.peripherals.ADC, 0x21);
            ///  Analog Comparator
            pub const AC = @intToPtr(*volatile types.peripherals.AC, 0x28);
            ///  CPU Registers
            pub const CPU = @intToPtr(*volatile types.peripherals.CPU, 0x2a);
            ///  Universal Serial Interface
            pub const USI = @intToPtr(*volatile types.peripherals.USI, 0x2d);
            ///  Timer/Counter, 8-bit
            pub const TC0 = @intToPtr(*volatile types.peripherals.TC8.TC0, 0x32);
            ///  I/O Port
            ...
            ///  External Interrupts
            pub const EXINT = @intToPtr(*volatile types.peripherals.EXINT, 0x42);
            ///  Bootloader
