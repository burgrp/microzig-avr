...
pub const devices = struct {
    pub const ATtiny84A = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const TC1 = @as(*volatile types.peripherals.TC16.TC1, @ptrFromInt(0x2b));
    ...
    pub const peripherals = struct {
        ...
        pub const ADC = extern struct {
            pub const ANALOG_ADC_V_REF = enum(u2) {
                ...
                VCC_USED_AS_ANALOG_REFERENCE_DISCONNECTED_FROM_PA0_AREF = 0x0,
                ///  External voltage reference at PA0 (AREF) pin, internal reference turned off
                EXTERNAL_VOLTAGE_REFERENCE_AT_PA0_AREF_PIN_INTERNAL_REFERENCE_TURNED_OFF = 0x1,
                ///  Internal 1.1V voltage reference
                INTERNAL_1_1V_VOLTAGE_REFERENCE = 0x2,
                ///  Reserved
                RESERVED = 0x3,
            };
