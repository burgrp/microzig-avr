...
pub const devices = struct {
    pub const ATmega4809 = struct {
        ...
        pub const peripherals = struct {
            ...
            ///  Virtual Ports
            pub const VPORTD = @as(*volatile types.peripherals.VPORT, @ptrFromInt(0xc));
            ///  Virtual Ports
            pub const VPORTE = @as(*volatile types.peripherals.VPORT, @ptrFromInt(0x10));
            ///  Virtual Ports
            pub const VPORTF = @as(*volatile types.peripherals.VPORT, @ptrFromInt(0x14));
            ///  General Purpose IO
            ...
            ///  I/O Ports
            pub const PORTD = @as(*volatile types.peripherals.PORT, @ptrFromInt(0x460));
            ///  I/O Ports
            pub const PORTE = @as(*volatile types.peripherals.PORT, @ptrFromInt(0x480));
            ///  I/O Ports
            pub const PORTF = @as(*volatile types.peripherals.PORT, @ptrFromInt(0x4a0));
            ///  Port Multiplexer
            ...
            ///  Universal Synchronous and Asynchronous Receiver and Transmitter
            pub const USART2 = @as(*volatile types.peripherals.USART, @ptrFromInt(0x840));
            ///  Universal Synchronous and Asynchronous Receiver and Transmitter
            pub const USART3 = @as(*volatile types.peripherals.USART, @ptrFromInt(0x860));
            ///  Two-Wire Interface
            ...
            ///  16-bit Timer Type B
            pub const TCB2 = @as(*volatile types.peripherals.TCB, @ptrFromInt(0xaa0));
            ///  16-bit Timer Type B
            pub const TCB3 = @as(*volatile types.peripherals.TCB, @ptrFromInt(0xab0));
