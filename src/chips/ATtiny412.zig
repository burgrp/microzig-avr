...
pub const devices = struct {
    pub const ATtiny412 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const DAC0 = @intToPtr(*volatile types.peripherals.DAC, 0x680);
            ...
            ///  Timer Counter D
            pub const TCD0 = @intToPtr(*volatile types.peripherals.TCD, 0xa80);
