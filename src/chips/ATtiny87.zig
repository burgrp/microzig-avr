...
pub const devices = struct {
    pub const ATtiny87 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const TC0 = @intToPtr(*volatile types.peripherals.TC8_ASYNC.TC0, 0x35);
            ...
            ///  Current Source
            pub const CURRENT_SOURCE = @intToPtr(*volatile types.peripherals.CURRENT_SOURCE, 0x77);
