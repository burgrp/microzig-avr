    ...
    pub const peripherals = struct {
        ...
        pub const USART = struct {
            ...
            pub const USART0 = extern struct {
                ...
                UBRR0: mmio.Mmio(packed struct(u16) {
                    ///  USART Baud Rate Register
                    UBRR0: u12,
                    padding: u4,
                }),
                ///  USART I/O Data Register
                UDR0: mmio.Mmio(packed struct(u8) {
                    ///  USART I/O Data bits
                    UDR0: u8,
                }),
            };
            ...
            pub const USART1 = extern struct {
                ...
                reserved4: [1]u8,
                ///  USART Baud Rate Register Bytes
                UBRR1: mmio.Mmio(packed struct(u16) {
                    ///  USART Baud Rate Register
                    UBRR1: u12,
                    padding: u4,
                }),
        ...
        pub const TC8_ASYNC = struct {
            ...
            pub const TC2 = extern struct {
                ...
                ///  Timer/Counter2
                TCNT2: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter2 bits
                    TCNT2: u8,
                }),
                ///  Timer/Counter2 Output Compare Register A
                OCR2A: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter2 Output Compare A bits
                    OCR2A: u8,
                }),
                ///  Timer/Counter2 Output Compare Register B
                OCR2B: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter2 Output Compare B bits
                    OCR2B: u8,
                }),
                reserved127: [1]u8,
