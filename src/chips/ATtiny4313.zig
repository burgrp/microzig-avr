...
pub const devices = struct {
    pub const ATtiny4313 = struct {
        ...
        pub const VectorTable = extern struct {
            ...
            PCINT_A: Handler = unhandled,
            ///  Pin Change Interrupt Request D
            PCINT_D: Handler = unhandled,
        };
        ...
        pub const peripherals = struct {
            ...
            ///  USART
            pub const USART = @intToPtr(*volatile types.peripherals.USART, 0x22);
            ///  External Interrupts
            pub const EXINT = @intToPtr(*volatile types.peripherals.EXINT, 0x24);
            ///  CPU Registers
            pub const CPU = @intToPtr(*volatile types.peripherals.CPU, 0x26);
            ...
            pub const TC1 = @intToPtr(*volatile types.peripherals.TC16.TC1, 0x42);
            ///  Timer/Counter, 8-bit
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const CPU = extern struct {
            pub const CPU_SLEEP_MODE3 = enum(u3) {
                ///  Idle
                IDLE = 0x0,
                ///  Power Down
                PDOWN2 = 0x1,
