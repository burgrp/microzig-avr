    ...
    pub const peripherals = struct {
        ...
        pub const USART = struct {
            ...
            pub const USART1 = extern struct {
                ...
                UDR1: mmio.Mmio(packed struct(u8) {
                    ///  USART I/O Data bits
                    UDR1: u8,
                }),
            };
        ...
        pub const TC8 = struct {
            ...
            pub const TC0 = extern struct {
                ...
                OCR0A: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter0 Output Compare A bits
                    OCR0A: u8,
                }),
                ///  Timer/Counter0 Output Compare Register
                OCR0B: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter0 Output Compare B bits
                    OCR0B: u8,
                }),
                reserved57: [37]u8,
        ...
        pub const TC10 = struct {
            ...
            pub const TC4 = extern struct {
                ...
                TCNT4: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 bits
                    TC4: u8,
                }),
                ///  Timer/Counter4
                TC4H: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 bits
                    TC4: u3,
                    padding: u5,
                }),
                ...
                OCR4A: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 Output Compare A bits
                    OCR4A: u8,
                }),
                ///  Timer/Counter4 Output Compare Register B
                OCR4B: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 Output Compare B bits
                    OCR4B: u8,
                }),
                ///  Timer/Counter4 Output Compare Register C
                OCR4C: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 Output Compare C bits
                    OCR4C: u8,
                }),
                ///  Timer/Counter4 Output Compare Register D
                OCR4D: mmio.Mmio(packed struct(u8) {
                    ///  Timer/Counter4 Output Compare D bits
                    OCR4D: u8,
                }),
                reserved155: [1]u8,
        ...
        pub const TC16 = struct {
            ...
            pub const TC3 = extern struct {
                ...
                TCNT3: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter3 bits
                    TCNT3: u16,
                }),
                ///  Timer/Counter3 Input Capture Register Bytes
                ICR3: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter3 Input Capture bits
                    ICR3: u16,
                }),
                ///  Timer/Counter3 Output Compare Register A Bytes
                OCR3A: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter3 Output Compare A bits
                    OCR3A: u16,
                }),
                ///  Timer/Counter3 Output Compare Register B Bytes
                OCR3B: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter3 Output Compare B bits
                    OCR3B: u16,
                }),
                ///  Timer/Counter3 Output Compare Register C Bytes
                OCR3C: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter3 Output Compare C bits
                    OCR3C: u16,
                }),
            };
            ...
            pub const TC1 = extern struct {
                ...
                ICR1: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter1 Input Capture bits
                    ICR1: u16,
                }),
                ///  Timer/Counter1 Output Compare Register A Bytes
                OCR1A: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter1 Output Compare A bits
                    OCR1A: u16,
                }),
                ///  Timer/Counter1 Output Compare Register B Bytes
                OCR1B: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter1 Output Compare B bits
                    OCR1B: u16,
                }),
                ///  Timer/Counter1 Output Compare Register C Bytes
                OCR1C: mmio.Mmio(packed struct(u16) {
                    ///  Timer/Counter1 Output Compare C bits
                    OCR1C: u16,
                }),
            };
        };
